...
class ConversationService
{
    ...
    public function addAdmin(
        ...
        if ($participant->conversation_Role === 'owner') {
            throw new \Exception(
                'Conversation owner cannot be promoted to admin.'
            );
        }

        if ($participant->conversation_Role === 'admin') {
            throw new \Exception(
                'User is already an admin.'
            );
        }

        return $this->repo->promoteToAdmin($conversation, $user);
    }
    ...
    public function removeAdmin(
        ...
        return $this->repo
            ->demoteToMember($conversation, $user);
    }
