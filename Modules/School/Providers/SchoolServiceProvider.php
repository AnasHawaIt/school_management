...
class SchoolServiceProvider extends ServiceProvider
{
    ...
    protected function registerRepositories(): void
    {
        ...
        $this->app->bind(
            \Modules\School\Contracts\Repositories\AcademicYearRepositoryInterface::class,
            \Modules\School\Repositories\AcademicYearRepository::class
        );

        // Semester Repository
        $this->app->bind(
            \Modules\School\Contracts\Repositories\SemesterRepositoryInterface::class,
            \Modules\School\Repositories\SemesterRepository::class
        );

        // Grade Repository
        $this->app->bind(
            \Modules\School\Contracts\Repositories\GradeRepositoryInterface::class,
            \Modules\School\Repositories\GradeRepository::class
        );

        // SchoolClass Repository
        $this->app->bind(
            \Modules\School\Contracts\Repositories\SchoolClassRepositoryInterface::class,
            \Modules\School\Repositories\SchoolClassRepository::class
        );

        // Section Repository
        $this->app->bind(
            \Modules\School\Contracts\Repositories\SectionRepositoryInterface::class,
            \Modules\School\Repositories\SectionRepository::class
        );

        // Holiday Repository
        $this->app->bind(
            \Modules\School\Contracts\Repositories\HolidayRepositoryInterface::class,
            \Modules\School\Repositories\HolidayRepository::class
        );
    }
